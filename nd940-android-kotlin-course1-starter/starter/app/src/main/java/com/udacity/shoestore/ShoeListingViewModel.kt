...
val SHOE1 = Shoe(name = "Adidas Runner 300", _size = 42.0, company = "Adidas", description = "Running shoes for 300M",
    images = listOf(
...
val SHOE2 = Shoe(name = "Ultraboost SUMMER.RDY", _size = 42.0, company = "Adidas", description = "HIGH-PERFORMANCE SHOES FOR RUNNING IN THE HEAT",
    images = listOf(
...
val SHOE3 = Shoe(name = "Nike Adapt BB", _size = 42.0, company = "Nike", description = "Breaking Down the Nike Adapt BB",
    images = listOf(
